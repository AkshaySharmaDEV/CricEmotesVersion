...
public class PluginTest1 : MonoBehaviour {
	...
	public void ShareButtonTapped()
	{
		...
		// }
		ShareScreenShot(Application.productName + "App provides various exciting cricket emotes to share in social medias", (int result) => {

...
public class PluginTest : MonoBehaviour {
	...
	public void ShareButtonTapped()
	{
		...
		ShareScreenShot(Application.productName + " App is Providing FREE Jee/Neet Materials,Study Games,Study Musics,Live Chat With Other App Users,Calculator Download The App From Here https://www.entrancebro.online/p/download.html ", (int result) => {
			Debug.Log("Share complete with: " + result);
			showAlertDialog(new string[] { "Share Complete", "Thanks For Sharing " + result, "OK" });
			if (shareButton != null)
	...
	public void OpenWebViewTapped()
	{
		...
		OpenWebView("https://www.entrancebro.online/p/download.html", stripHeight);
	}
